...
export default async function EditContractPage({
  ...
  return (
    <>
      ...
      <Card>
        {!canWrite ? (
          <p className="text-body text-content-muted">Sem permissão para editar contratos neste tenant.</p>
        ) : (
          <form action={boundAction} className="flex flex-col gap-card-gap">
            ...
            <p className="text-body text-content-muted">
              Principal, número de parcelas, data de início e política de adiantamento não podem ser
              alterados depois que o contrato é criado.
            </p>
