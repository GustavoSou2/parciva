...
export type EditPayerPageParams = {
...
export async function EditPayerFormContent({ params, searchParams }: EditPayerPageParams) {
  ...
  if (!canWrite) {
    return <p className="text-body text-content-muted">Sem permissão para editar pagadores neste tenant.</p>;
  }
